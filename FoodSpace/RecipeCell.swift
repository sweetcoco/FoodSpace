...
//  FoodSpace
//
//  Created by Corey Howell on 10/8/16.
...
class RecipeCell: UITableViewCell {
    ...
    override init(style: UITableViewCellStyle, reuseIdentifier: String?) {
        ...
        nameLabel.anchorWithConstantsToTop(top: contentView.topAnchor, left: contentView.leftAnchor, bottom: nil, right: contentView.rightAnchor, topConstant: 10, leftConstant: 8, bottomConstant: 0, rightConstant: 20)
    ...
    func createTopSeparatorView() {
        ...
        topSeparatorView.anchorWithConstantsToTop(top: contentView.topAnchor, left: contentView.leftAnchor, bottom: nameLabel.topAnchor, right: contentView.rightAnchor, topConstant: 5, leftConstant: 8, bottomConstant: 0, rightConstant: 8)
